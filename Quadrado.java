...
/**
 * Classe usada para desenhar a forma Quadrado
...
public final class Quadrado extends Forma2D {
    ...
    public Quadrado(int x1, int y1, int x2, int y2, Color color) {
        super(x1,y1,x2,y2);
        this.color = color;
        calcularTamanho();
        verificaPosicao();
    ...
    public void desenhaQuadrado(Graphics g){
        ...
        g.drawRect(x,y,(int)base,(int)altura);
    }   
    
    @Override
    public void preencheQuadrado(Graphics g){
        g.setColor(this.color);
        g.fillRect(x,y,(int)base,(int)altura);
    }
